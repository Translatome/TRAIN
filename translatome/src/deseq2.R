...
myconditions$combine <- interaction(
  myconditions$fraction,
...
## function(matrix, metadata, design, factor1, factor2,
## filterMethods, fitmodel, output)
tryCatch(
  expr = {
...
tryCatch(
  expr = {
    ...
    # Scree plot as hist
    histplot <- ScreeHist(res_pca3$eig_val)
